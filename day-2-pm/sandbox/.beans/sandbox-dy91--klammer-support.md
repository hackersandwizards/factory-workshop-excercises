...
Calculator soll Klammern unterstützen, um Auswertungs-Reihenfolge explizit steuern zu können. `(1+2)*3` muss 9 ergeben, `((1+2))` muss 3 ergeben (verschachtelt). Unbalancierte Eingaben wie `(1+2` führen zu einem lesbaren Parse-Error statt einem Crash.
