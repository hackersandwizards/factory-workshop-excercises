...
- Division by zero remains a runtime error via `CalcError`; the REPL stays the single catch point.
...
- `1/0` raises a runtime error; the REPL catches it, prints an understandable message, and keeps running.
