# Day 2 · Exercise 03 — Subagent

**Slot:** Day 2 morning · 45 minutes. On day 1 subagents are only *named*
(block 3, see `day-1/04-planner/README.md` — "Why not a subagent (yet)").
They earn their keep here, and again in Refine (day 2 PM), which is exactly
this mechanism.
